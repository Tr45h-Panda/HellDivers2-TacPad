...
void ui_Screen2_screen_init(void)
{
    ...
    lv_img_set_src(ui_Image2, &ui_img_312027341);
    lv_obj_set_width(ui_Image2, LV_SIZE_CONTENT);   /// 320
    lv_obj_set_height(ui_Image2, LV_SIZE_CONTENT);    /// 179
    ...
    lv_obj_set_style_bg_img_src(ui_Button2, &ui_img_rightarrow_png, LV_PART_MAIN | LV_STATE_DEFAULT);
